CREATE OR ALTER PROCEDURE usp_AddDefaultConstraint @Table NVARCHAR(100), @Column NVARCHAR(100), @originalDefault NVARCHAR(100) AS
BEGIN
...
SET @do= N'ALTER TABLE ' + @Table + N' ADD CONSTRAINT DF_' + @Column + N' DEFAULT ' + @originalDefault + N' FOR ' + @Column;
...
EXEC usp_AddDefaultConstraint @Table='Festival', @Column= 'test', @originalDefault = '1';